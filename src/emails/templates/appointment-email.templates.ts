...
export function renderAppointmentEmailTemplate(
  ...
  const definitions: Record<AppointmentEmailTemplate, EmailTemplateResult> = {
    'appointment-created-client': {
      subject: `Seu agendamento em ${input.businessName} foi criado`,
      html: `<p>Ola ${input.clientName}, seu agendamento foi criado.</p><p>${baseLines.join(
        '<br />',
      )}</p>`,
    ...
    'appointment-confirmed-client': {
      ...
      html: `<p>Ola ${input.clientName}, seu agendamento foi confirmado.</p><p>${baseLines.join(
        '<br />',
      )}</p>`,
    ...
    'appointment-cancelled-client': {
      ...
      html: `<p>Ola ${input.clientName}, seu agendamento foi cancelado.</p><p>${baseLines.join(
        '<br />',
      )}</p>`,
    ...
    'appointment-reminder-24h': {
      ...
      html: `<p>Ola ${input.clientName}, este e um lembrete do seu agendamento em 24 horas.</p><p>${baseLines.join(
        '<br />',
      )}</p>`,
    ...
    'appointment-reminder-2h': {
      ...
      html: `<p>Ola ${input.clientName}, este e um lembrete do seu agendamento em 2 horas.</p><p>${baseLines.join(
        '<br />',
      )}</p>`,
