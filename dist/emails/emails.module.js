...
const emails_processor_1 = require("../queue/emails.processor");
const reminders_processor_1 = require("../queue/reminders.processor");
...
exports.EmailsModule = EmailsModule = __decorate([
    (0, common_1.Module)({
        providers: [emails_service_1.EmailsService, emails_processor_1.EmailsProcessor, reminders_processor_1.RemindersProcessor],
