...
exports.AppointmentRangeQueryDto = exports.CancelAppointmentDto = exports.CreateAppointmentDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2026-04-14T15:00:00.000Z' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'app' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Cliente nao pode comparecer' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(500),
    __metadata("design:type", String)
], CancelAppointmentDto.prototype, "reason", void 0);
class AppointmentRangeQueryDto {
    startDate;
    endDate;
}
exports.AppointmentRangeQueryDto = AppointmentRangeQueryDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2026-04-14' }),
    (0, class_validator_1.Matches)(/^\d{4}-\d{2}-\d{2}$/),
    __metadata("design:type", String)
], AppointmentRangeQueryDto.prototype, "startDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2026-04-20' }),
    (0, class_validator_1.Matches)(/^\d{4}-\d{2}-\d{2}$/),
    __metadata("design:type", String)
], AppointmentRangeQueryDto.prototype, "endDate", void 0);
